...
RUN set -ex; \
  ...
  wget -O "${FLINK_HOME}"/lib/flink-s3-fs-presto-$FLINK_TAG.jar https://repo1.maven.org/maven2/org/apache/flink/flink-s3-fs-presto/$FLINK_TAG/flink-s3-fs-presto-$FLINK_TAG.jar
